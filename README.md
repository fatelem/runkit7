...
__Now with partial support for PHP7.0 and PHP7.1!__ and PHP 7.2.0alpha3 (function/method manipulation is recommended only for unit testing).
...
In 7.0.x and 7.1.x and 7.2.0alpha3: 0 failing tests, 4 expected failures (constant manipulation in same file), 61 skipped tests(for disabled property and import), and 95 passing tests.

Compatability: PHP7.0 and PHP7.1 and PHP7.2alpha3(Partial)
-----------------------------------------
...
- `runkit-superglobal` works reliably in 7.0.x and 7.1.x.
  Haven't gotten around to extensively testing it with 7.2.0alpha3 yet.
